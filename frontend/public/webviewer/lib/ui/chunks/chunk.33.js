  ...
  [33],
  {
    ...
    1491: function (e, t, n) {
      ...
      var L = Object(o.lazy)(function () {
          return Promise.resolve().then(n.bind(null, 1596));
        }),
        A = {
      ...
      var B = function () {
          var e = D(
              Object(i.e)(function (e) {
                return [
                  O.a.isElementDisabled(e, k.a.OUTLINE_PANEL),
                  O.a.getOutlines(e),
                  O.a.getOutlineEditingEnabled(e),
                  O.a.shouldAutoExpandOutlines(e),
                  O.a.getCurrentPage(e),
                  O.a.getPageLabels(e),
                  O.a.getFeatureFlags(e),
                ];
              }, i.c),
              7,
            ),
            ...
            _ = "Area Selection",
            R = { x: 0, y: 0 },
            M = D(Object(o.useState)(I), 2),
            B = M[0],
            F = M[1],
            G = D(Object(o.useState)(R), 2),
            H = G[0],
            U = G[1],
            W = D(Object(o.useState)(T), 2),
            z = W[0],
            V = W[1],
            q = D(Object(o.useState)(!1), 2),
            Y = q[0],
            K = q[1],
            Z = D(Object(o.useState)(null), 2),
            $ = Z[0],
            J = Z[1],
            X = D(Object(o.useState)(!1), 2),
            Q = X[0],
            ee = X[1],
            te = D(Object(o.useState)({}), 2),
            ne = te[0],
            oe = te[1],
            re = D(Object(o.useState)(!1), 2),
            ie = re[0],
            ae = re[1],
            le = D(Object(o.useState)(!1), 2),
            ue = le[0],
            ce = le[1],
            se = D(Object(o.useState)([]), 2),
            de = se[0],
            pe = se[1],
            fe = N.customizableUI,
            me = D(Object(a.a)(), 1)[0],
            be = Object(i.d)(),
            ge = Object(o.useRef)(null),
          ...
          Object(o.useLayoutEffect)(
            function () {
              ee(!1),
                null !== ge.current && (J(ge.current), (ge.current = null)),
                0 === n.length && ce(!1);
            },
            [n],
          ),
            Object(o.useEffect)(
              function () {
                K(h.a.isFullPDFEnabled() && x);
              },
              [x],
            ),
            Object(o.useEffect)(
              function () {
                var e = Object.values(ne).some(function (e) {
                  return e;
                });
                ae(e);
              },
            ...
            Object(o.useEffect)(function () {
              var e = function (e) {
                  F(e.IsText ? e.getCustomData("trn-annot-preview") : _),
                    U({ x: e.X, y: e.Y }),
                    V(e.PageNumber);
                },
                t = function () {
                  h.a.getOutlines(function (e) {
                    be(w.a.setOutlines(e));
                  });
                },
                n = function () {
                  J(null);
            ...
            Object(o.useEffect)(function () {
              ...
              return (
                ke.current && ke.current.addEventListener("click", e),
                function () {
                  ke.current && ke.current.removeEventListener("click", e);
                }
              );
            }, []);
          var ye = function (e, t) {
                      ...
                      switch ((e.prev = e.next)) {
                        case 0:
                          if (
                            ...
                            (a = t),
                            [I, _].includes(B) || t
                              ? t || (a = me("message.untitled"))
                              : (a = B.slice(0, 40)),
                            (l = h.a.getDocumentViewer().getDocument()),
                            ((u = l.getPageRotation(z) / 90) !==
                          ...
                          return (
                            (e.next = 9), v.a.addRootOutline(a, z, r, i, 0)
                          );
                        case 9:
                          e.next = 13;
                          break;
                        case 11:
                          return (
                            (e.next = 13), v.a.addNewOutline(a, $, z, r, i, 0)
                          );
                        case 13:
                          Oe();
                        case 14:
                      ...
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            ...
                            ((a = i.getPageRotation(z) / 90) !==
                              window.Core.PageRotation.E_90 &&
                              a !== window.Core.PageRotation.E_270) ||
                              ((l = o), (o = r), (r = l)),
                            (e.next = 6),
                            v.a.setOutlineDestination(t, z, o, r, 0)
                          );
                        case 6:
                          (ge.current = t), Oe();
                        case 8:
          ...
          var Le = function (e, t, n) {
            ...
            Ae = function (e, t) {
              Le(e, t, v.a.moveOutlineAfterTarget);
            },
            Ne = function (e, t) {
              Le(e, t, v.a.moveOutlineBeforeTarget);
            },
            je = function (e, t) {
              Le(e, t, v.a.moveOutlineInTarget);
            },
            Ie = (function () {
              var e = C(
                    ...
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          t.sort().reverse(),
                            (n = {
                              message: me("warning.deleteOutline.message"),
                              title: me("warning.deleteOutline.title"),
                              confirmBtnText: me("action.delete"),
                              onConfirm: (function () {
                                var e = C(
                                  S().mark(function e() {
                                    var n, o;
          ...
          return t
            ...
            : r.a.createElement(
                "div",
                {
                  className: j()("Panel OutlinesPanel bookmark-outline-panel", {
                    "modular-ui-panel": fe,
                  }),
                  "data-element": k.a.OUTLINE_PANEL,
                  ref: ke,
                },
                r.a.createElement(
                  "div",
                  ...
                  r.a.createElement(
                    ...
                    me("component.outlinesPanel"),
                  ),
                  Y &&
                    (ue
                      ? r.a.createElement(m.a, {
                          className: "bookmark-outline-control-button",
                          dataElement: k.a.OUTLINE_MULTI_SELECT,
                          label: me("option.bookmarkOutlineControls.done"),
                          disabled: Q,
                          onClick: function () {
                            return ce(!1);
                          },
                          ariaLabel: ""
                            .concat(
                              me("option.bookmarkOutlineControls.done"),
                              " ",
                            )
                            .concat(me("action.edit")),
                        })
                      : r.a.createElement(m.a, {
                          className: "bookmark-outline-control-button",
                          dataElement: k.a.OUTLINE_MULTI_SELECT,
                          label: me("option.bookmarkOutlineControls.edit"),
                          ...
                          ariaLabel: ""
                            .concat(me("action.edit"), " ")
                            .concat(me("component.outlinesPanel")),
                        })),
                ),
                r.a.createElement(
                  p.a.Provider,
                  {
                    value: {
                      ...
                      setAddingNewOutline: ee,
                      isAddingNewOutline: Q,
                      setEditingOutlines: oe,
                      editingOutlines: ne,
                      selectedOutlines: de,
                      isAnyOutlineRenaming: ie,
                      isMultiSelectMode: ue,
                      shouldAutoExpandOutlines: E,
                      isOutlineEditable: Y,
                      addNewOutline: we,
                      updateOutlines: Oe,
                      renameOutline: Ie,
                      updateOutlineDest: Te,
                      removeOutlines: Pe,
                    },
                  },
                  r.a.createElement(
                    ...
                    r.a.createElement(
                      ...
                      n.map(function (e) {
                        return r.a.createElement(d.default, {
                          ...
                          moveOutlineInward: je,
                          moveOutlineBeforeTarget: Ne,
                          moveOutlineAfterTarget: Ae,
                        });
                      }),
                      Q &&
                        null === $ &&
                  ...
                  Y &&
                    r.a.createElement(
                      g.a,
                      {
                        ...
                        dataElement: k.a.OUTLINE_ADD_NEW_BUTTON_CONTAINER,
                      },
                      ue
                        ? r.a.createElement(
                            r.a.Fragment,
                            ...
                            r.a.createElement(f.a, {
                              ...
                              img: "icon-menu-add",
                              ariaLabel: ""
                                .concat(me("action.add"), " ")
                                .concat(me("component.outlinesPanel")),
                              disabled: de.length > 0 || Q || ie,
                              onClick: function () {
                                return ee(!0);
                              },
                            }),
                        ...
                        : r.a.createElement(m.a, {
                            ...
                            img: "icon-menu-add",
                            dataElement: k.a.OUTLINE_ADD_NEW_BUTTON,
                            disabled: Q || ie,
                            label: ""
                              .concat(me("action.add"), " ")
                              .concat(me("component.outlinePanel")),
                            onClick: function () {
                              return ee(!0);
                            },
                            ariaLabel: ""
