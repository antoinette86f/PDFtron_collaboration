  ...
  [41],
  {
    ...
    1900: function (t, e, n) {
      ...
      var o = n(0),
        ...
        O = n(52),
        x = n(21),
        P = (n(35), n(27), n(28), n(25), n(32), n(54), n(56), n(55), n(173)),
        S = n.n(P),
        T = n(19),
        C = n.n(T),
        N = n(289),
      ...
      var Y = window.Core.Scale,
        ...
        V = { annotation: l.a.shape({ Scale: l.a.arrayOf(l.a.array) }) },
        K = function (t) {
          var e,
            n,
            r = t.annotation,
      ...
      var nt = {
        ...
        ot = function (t) {
          var e,
            ...
            y = t.popupRef,
            b = t.position,
            v = t.multipleAnnotationsSelected,
            g = t.showViewFileButton,
            w = t.onViewFile,
            A = t.showCommentButton,
            O = t.onCommentAnnotation,
            P = t.isDateFreeTextCanEdit,
            T = t.isDatePickerOpen,
            j = t.handleDateChange,
            _ = t.onDatePickerShow,
            F = t.isCalibrationPopupOpen,
            D = t.showEditStyleButton,
            R = t.isStylePopupOpen,
            B = t.hideSnapModeCheckbox,
            U = t.openEditStylePopup,
            z = t.closeEditStylePopup,
            W = t.annotationStyle,
            G = t.onResize,
            Y = t.showContentEditButton,
            H = t.onEditContent,
            V = t.openContentEditDeleteWarningModal,
            K = t.isAppearanceSignature,
            J = t.onClearAppearanceSignature,
            X = t.showRedactionButton,
            Z = t.onApplyRedaction,
            et = t.showGroupButton,
            nt = t.onGroupAnnotations,
            ot = t.showUngroupButton,
            it = t.onUngroupAnnotations,
            at = t.showFormFieldButton,
            rt = t.onOpenFormField,
            lt = t.showDeleteButton,
            ct = t.onDeleteAnnotation,
            ut = t.showLinkButton,
            st = t.hasAssociatedLink,
            pt = t.linkAnnotationToURL,
            dt = t.showFileDownloadButton,
            ft = t.downloadFileAttachment,
            mt = t.showAudioPlayButton,
            ht = t.handlePlaySound,
            yt = t.showCalibrateButton,
            bt = t.onOpenCalibration,
            vt = t.customizableUI,
            gt = t.openStylePanel,
            wt = t.isInReadOnlyMode,
            At = t.onOpenAlignmentModal,
            Et = tt(Object(h.a)(), 1)[0],
            Ot = tt(Object(o.useState)(!1), 2),
            xt = Ot[0],
            Pt = Ot[1],
            St = P ? "action.changeDate" : "action.comment",
            Tt = P
            ...
            Ct =
              ...
              !a,
            Nt = m instanceof window.Core.Annotations.RectangleAnnotation,
            kt = m instanceof window.Core.Annotations.EllipseAnnotation,
            Lt = m instanceof window.Core.Annotations.PolygonAnnotation,
            jt =
              ...
              (m.getIntent() ===
                ...
                m.getIntent() ===
                  window.Core.Annotations.FreeTextAnnotation.Intent
                    .FreeTextCallout),
            _t = m instanceof window.Core.Annotations.RedactionAnnotation,
            Ft = Object($.g)(m),
            Dt = !!m.Measure,
            It = Object($.e)(Object($.j)(m.ToolName)).hasLineEndings,
            Mt =
            ...
            Bt =
              null === (n = m.isContentEditPlaceholder) || void 0 === n
                ...
                : n.call(m),
            Ut =
              m instanceof window.Core.Annotations.SignatureWidgetAnnotation &&
              m.fieldFlags.get(window.Core.Annotations.WidgetFlags.READ_ONLY);
          try {
            Rt =
              "dash" === m.Style
          ...
          if (
            ...
            var Wt,
              ...
              Xt,
              Qt,
              Zt = m.getRichTextStyle(),
              te = m.isAutoSizeFont(),
              ee = m.getCalculatedFontSize();
            zt = {
              Font: m.Font,
              FontSize: m.FontSize,
              ...
              bold:
                null !==
                  (Wt =
                    "bold" ===
                    (null == Zt || null === (Gt = Zt[0]) || void 0 === Gt
                      ? void 0
                      : Gt["font-weight"])) &&
                void 0 !== Wt &&
                Wt,
              italic:
                null !==
                  (Yt =
                    "italic" ===
                    (null == Zt || null === (Ht = Zt[0]) || void 0 === Ht
                      ? void 0
                      : Ht["font-style"])) &&
                void 0 !== Yt &&
                Yt,
              ...
              strikeout:
                null !==
                  (Jt =
                    ...
                    null === (Xt = Zt[0]) ||
                    void 0 === Xt ||
                    null === (Qt = Xt["text-decoration"]) ||
                    void 0 === Qt
                      ? void 0
                      : Qt.includes("line-through")) &&
                void 0 !== Jt &&
                Jt,
              StrokeStyle: Rt,
              isAutoSizeFont: te,
              calculatedFontSize: ee,
            };
          }
          _t &&
            (zt = {
              ...
              switch (!0) {
                case R:
                  return i.a.createElement(L.a, {
                    ...
                    isMeasure: Dt,
                    colorMapKey: Ft,
                    showLineStyleOptions: It,
                    properties: zt,
                    hideSnapModeCheckbox: B,
                    hasBackToMenu: c,
                    onBackToMenu: z,
                  });
                case T:
                ...
                case F:
                  return i.a.createElement(q, { annotation: m });
                case xt &&
                  m instanceof window.Core.Annotations.Model3DAnnotation:
                  return i.a.createElement(
                    "div",
                    ...
                    i.a.createElement(
                      ...
                      Et("action.rotate3D"),
                      " ",
                      i.a.createElement("span", null, Et("shortcut.rotate3D")),
                    ),
                    i.a.createElement(
                      "div",
                      { className: "row" },
                      Et("action.zoom"),
                      " ",
                      i.a.createElement("span", null, Et("shortcut.zoom3D")),
                    ),
                  );
                default:
                  return i.a.createElement(
                    N.a,
                    { locked: l && Mt && !s && !u && !p && !d && !jt && !f },
                    i.a.createElement(
                      "div",
                      { className: "container" },
                      i.a.createElement(
                        ...
                        ut &&
                          i.a.createElement(k.a, {
                            ...
                            label: c ? "tool.Link" : "",
                            title: c ? "" : "tool.Link",
                            img: st ? "icon-tool-unlink" : "icon-tool-link",
                            onClick: pt,
                          }),
                        dt &&
                          i.a.createElement(k.a, {
      ...
      var pt = window.Core.Tools.ToolNames,
        ...
        mt = function t(e) {
          var n = e.focusedAnnotation,
            ...
            st = Object(a.d)(),
            ft = ut(Object(o.useState)({ left: -99999, top: -99999 }), 2),
            mt = ft[0],
            ht = ft[1],
            ...
            vt = yt[1],
            gt = Object(o.useRef)(),
            wt = !U || p.a.isAnnotationSelected(n, tt),
            At = p.a.getAnnotationManager(tt),
            Et = Y || (X && Q && "notesPanel" === Z) || et,
            Ot = nt.customizableUI;
          Object(g.a)(
            gt,
          ...
          var xt = u()(
            function () {
              t && gt.current && ht(Object(d.c)(n, gt, tt));
            },
            16,
          ...
          Object(o.useEffect)(function () {
            ...
            Object(o.useEffect)(
              function () {
                n && n.ToolName === pt.CALIBRATION_MEASUREMENT && vt(!0);
              },
              [n],
            ),
            Object(o.useEffect)(
          ...
          var Pt = !!Object(v.a)("webviewerServerURL", null)
          ...
          if (M || !n) return null;
          var Ct = p.a.getSelectedAnnotations(tt),
            Nt = Ct.length,
            kt = Nt > 1,
            Lt =
            ...
            zt = n instanceof dt.EllipseAnnotation || !p.a.isFullPDFEnabled(),
            Wt =
              n.isContentEditPlaceholder() &&
                ...
                rt().mark(function t() {
                  return rt().wrap(function (t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          At.trigger("annotationDoubleClicked", n),
            ...
            Yt = p.a.isAnnotationRedactable(n, tt) && !kt && !j,
            Ht = Ct.find(function (t) {
              return !t.InReplyTo;
            }),
            Vt = l && wt && _t && !j,
            Kt = Ft,
            ...
            $t = j && qt && !(n instanceof dt.PushButtonWidgetAnnotation),
            Jt = l,
            Xt = function () {
              wt
            ...
            Zt = l && n.Measure && n instanceof dt.LineAnnotation,
            te = n instanceof dt.FileAttachmentAnnotation,
            ee = (function () {
              var t = ct(
          ...
          return i.a.createElement(it, {
            ...
            position: mt,
            focusedAnnotation: n,
            multipleAnnotationsSelected: kt,
            showViewFileButton: St,
            onViewFile: Tt,
            showCommentButton: Mt,
            ...
            handleDateChange: function (t) {
              At.setNoteContents(n, t), At.updateAnnotation(n);
            },
            onDatePickerShow: function (t) {
              k(t);
            },
            isCalibrationPopupOpen: bt,
            showEditStyleButton: Ut,
            isStylePopupOpen: P,
            hideSnapModeCheckbox: zt,
            ...
            isAppearanceSignature: Dt,
            onClearAppearanceSignature: function () {
              n.clearSignature(At), st(w.a.closeElement(E.a.ANNOTATION_POPUP));
            },
            showRedactionButton: Yt,
            ...
            onGroupAnnotations: function () {
              p.a.groupAnnotations(Ht, Ct, tt);
            },
            showUngroupButton: Kt,
            onUngroupAnnotations: function () {
              p.a.ungroupAnnotations(Ct, tt);
            },
            ...
            showDeleteButton: Jt,
            onDeleteAnnotation: Xt,
            showLinkButton: Qt,
            hasAssociatedLink: L,
            linkAnnotationToURL: function () {
              L
                ? ((wt ? Ct : [n]).forEach(function (t) {
                    Object(b.a)(t).forEach(function (e, n) {
                      At.ungroupAnnotations([e]),
                        t instanceof dt.TextHighlightAnnotation &&
                        0 === t.Opacity &&
                        0 === n
                          ? At.deleteAnnotations([t, e], null, !0)
                          : At.deleteAnnotation(e, null, !0);
                    });
                  }),
                  D())
            ...
            downloadFileAttachment: ee,
            showAudioPlayButton: ne,
